...
graphql_compose_1.schemaComposer.Query.addFields({
    ...
    authorFindById: author_1.authorFindById,
    authorConnection: author_1.authorConnection,
});
graphql_compose_1.schemaComposer.Mutation.addFields({
    ...
    authorCreateOne: author_1.authorCreateOne,
    authorCreateMany: author_1.authorCreateMany,
});
